...
export function WorkspaceShell({ children }: WorkspaceShellProps) {
  ...
  return (
    <RequireSession>
      ...
      {/* The top bar spans the viewport; the rail floats under it, on bg-surface so it
          reads as a control surface instead of page. No overflow here — the rail's
          hover labels and account menu escape its box. */}
      <header className="sticky top-0 z-40 grid h-14 grid-cols-[1fr_auto_1fr] items-center gap-2 bg-background px-4 md:px-7">
      ...
      <div className="min-h-screen bg-background lg:pl-16">
